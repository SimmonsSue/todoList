...
export class ShowList extends Component {
    ...
    constructor(props){
        super(props)
        this.state = ({shouldUpdateTodo:true, shouldUpdateDone:true})
        this.loadTodo = this.loadTodo.bind(this)
        this.loadDone = this.loadDone.bind(this)
        // this.deleteAllTodoFuc = this.deleteAllTodoFuc.bind(this)
        // this.deleteAllFinishFuc = this.deleteAllFinishFuc.bind(this)
        // this.deleteAllTodoFuc = this.deleteAllTodoFuc.bind(this)
